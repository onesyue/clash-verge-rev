...
export const translationKeys = [
  ...
  "account.login.hasAccount",
  "account.login.form.email",
  "account.login.form.password",
  "account.login.form.submit",
  "account.login.feedback.success",
  "account.login.feedback.failed",
  "account.register.tab",
  "account.register.form.email",
  "account.register.form.password",
  "account.register.form.confirmPassword",
  "account.register.form.inviteCode",
  "account.register.form.submit",
  "account.register.feedback.success",
  "account.register.feedback.failed",
  "account.register.feedback.passwordMismatch",
  "account.forgot.tab",
  "account.forgot.description",
  "account.forgot.backToLogin",
  "account.forgot.form.email",
  "account.forgot.form.sendCode",
  "account.forgot.form.resendCode",
  "account.forgot.form.resendCodeAction",
  "account.forgot.form.emailCode",
  "account.forgot.form.newPassword",
  "account.forgot.form.confirmNewPassword",
  "account.forgot.form.back",
  "account.forgot.form.submit",
  "account.forgot.emailHint",
  "account.forgot.feedback.codeSent",
  ...
  "account.session.feedback.logoutSuccess",
  "account.dashboard.refresh",
  "account.dashboard.loading",
  "account.dashboard.loadFailed",
  "account.dashboard.account.title",
  "account.dashboard.account.email",
  "account.dashboard.account.plan",
  "account.dashboard.account.noPlan",
  "account.dashboard.account.expiry",
  "account.dashboard.account.noExpiry",
  "account.dashboard.account.renewNow",
  "account.dashboard.account.renewNowExpired",
  "account.dashboard.account.uuid",
  "account.dashboard.account.subscribeUrl",
  "account.dashboard.account.syncNow",
  "account.dashboard.account.syncing",
  "account.dashboard.account.syncSuccess",
  "account.dashboard.account.syncFailed",
  "account.dashboard.traffic.title",
  "account.dashboard.traffic.used",
  "account.dashboard.traffic.remaining",
  "account.dashboard.traffic.total",
  "account.dashboard.traffic.unlimited",
  "account.dashboard.traffic.upload",
  "account.dashboard.traffic.download",
  "account.dashboard.traffic.usagePercent",
  "account.dashboard.traffic.noUsage",
  "account.dashboard.wallet.title",
  "account.dashboard.wallet.balance",
  "account.dashboard.wallet.commission",
  "account.dashboard.wallet.unit",
  "account.dashboard.invite.title",
  "account.dashboard.invite.referrals",
  "account.dashboard.invite.referralCount",
  "account.dashboard.invite.people",
  "account.dashboard.invite.copy",
  "account.dashboard.invite.copyLink",
  "account.dashboard.invite.linkCopied",
  "account.dashboard.invite.copyFailed",
  "account.dashboard.invite.noLink",
  "account.dashboard.changePassword.title",
  "account.dashboard.changePassword.oldPassword",
  "account.dashboard.changePassword.newPassword",
  "account.dashboard.changePassword.confirm",
  "account.dashboard.changePassword.success",
  "account.dashboard.changePassword.failed",
  "account.notices.page.title",
  "account.notices.loginRequired",
  "account.notices.loading",
  "account.notices.loadFailed",
  "account.notices.noNotices",
  "account.notices.retry",
  "account.notices.new",
  "account.notices.expand",
  "account.notices.collapse",
  "account.notices.newNoticeHint",
  "account.orders.page.title",
  "account.orders.loginRequired",
  "account.orders.loading",
  "account.orders.loadFailed",
  "account.orders.noOrders",
  ...
  "account.orders.columns.plan",
  "account.orders.columns.period",
  "account.orders.columns.amount",
  "account.orders.columns.status",
  "account.orders.columns.time",
  "account.orders.columns.tradeNo",
  "account.orders.actions.cancel",
  "account.orders.actions.payNow",
  "account.orders.actions.cancelConfirm",
  "account.orders.actions.cancelSuccess",
  "account.orders.actions.cancelFailed",
  "account.orders.payNow.title",
  "account.orders.payNow.waitingTitle",
  "account.orders.payNow.paymentMethod",
  "account.orders.payNow.noPaymentMethods",
  "account.orders.payNow.confirm",
  "account.orders.payNow.cancel",
  "account.orders.payNow.close",
  "account.orders.payNow.verifyPayment",
  "account.orders.payNow.waitingPayment",
  "account.orders.payNow.waitingPaymentHint",
  "account.orders.payNow.paymentPending",
  "account.orders.payNow.paymentVerified",
  "account.orders.payNow.loading",
  "account.orders.payNow.openingPayment",
  "account.orders.payNow.failed",
  "account.orders.payNow.freeSuccess",
  "account.shop.page.title",
  "account.shop.loginRequired",
  "account.shop.loading",
  "account.shop.loadFailed",
  "account.shop.noPlans",
  "account.shop.retry",
  "account.shop.plan.perMonth",
  "account.shop.plan.perQuarter",
  "account.shop.plan.perHalfYear",
  "account.shop.plan.perYear",
  "account.shop.plan.onetime",
  "account.shop.plan.period.month_price",
  "account.shop.plan.period.quarter_price",
  "account.shop.plan.period.half_year_price",
  "account.shop.plan.period.year_price",
  "account.shop.plan.period.onetime_price",
  "account.shop.checkout.title",
  "account.shop.checkout.waitingTitle",
  "account.shop.checkout.plan",
  "account.shop.checkout.period",
  "account.shop.checkout.amount",
  "account.shop.checkout.couponCode",
  "account.shop.checkout.couponCodePlaceholder",
  "account.shop.checkout.couponInvalid",
  "account.shop.checkout.couponDiscount",
  "account.shop.checkout.couponPercent",
  "account.shop.checkout.paymentMethod",
  "account.shop.checkout.noPaymentMethods",
  "account.shop.checkout.confirm",
  "account.shop.checkout.cancel",
  "account.shop.checkout.close",
  "account.shop.checkout.verifyPayment",
  "account.shop.checkout.waitingPayment",
  "account.shop.checkout.waitingPaymentHint",
  "account.shop.checkout.paymentPending",
  "account.shop.checkout.paymentVerified",
  "account.shop.checkout.loading",
  "account.shop.checkout.success",
  "account.shop.checkout.failed",
  ...
  "account.validation.emailInvalid",
  "account.validation.passwordRequired",
  "account.validation.passwordMinLength",
  "account.validation.confirmPasswordRequired",
  "account.validation.emailCodeRequired",
  "account.validation.emailCodeInvalid",
  ...
  "home.components.connectButton.status.connecting",
  "home.components.connectButton.status.connected",
  "home.components.connectButton.status.disconnected",
  "home.components.connectButton.action",
  "home.components.speedCard.download",
  "home.components.speedCard.upload",
  "home.components.speedCard.totalTraffic",
  "home.components.speedTest.title",
  "home.components.speedTest.testing",
  "home.components.speedTest.result",
  "home.components.speedTest.failed",
  "home.components.speedTest.noNode",
  "home.components.expiryBanner.expiringSoon",
  "home.components.expiryBanner.expired",
  "home.components.expiryBanner.renew",
  ...
  "home.components.currentProxy.labels.noProxy",
  "home.components.currentProxy.delay.testing",
  "home.components.currentProxy.delay.untested",
  "home.components.currentProxy.delay.error",
  "home.components.currentProxy.delay.timeout",
  "home.components.currentProxy.delay.high",
  "home.components.currentProxy.delay.medium",
  "home.components.currentProxy.delay.good",
  "home.components.currentProxy.delay.excellent",
  "home.components.currentProxy.messages.syncSuccess",
  "home.components.currentProxy.messages.syncFailed",
  "home.components.currentProxy.messages.syncing",
  "home.components.currentProxy.messages.noNodes",
  ...
  "home.components.clashMode.title",
  ...
  "home.notifications.expiryWarning",
  "home.notifications.expired",
  ...
  "layout.components.navigation.tabs.account",
  "layout.components.navigation.tabs.shop",
  "layout.components.navigation.tabs.orders",
  "layout.components.navigation.tabs.notices",
  ...
  "settings.sections.clash.form.fields.autoUpdateGeoData",
  "settings.sections.clash.form.fields.geoDataLastUpdated",
  "settings.sections.clash.form.fields.geoDataNeverUpdated",
